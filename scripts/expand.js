...
$.fn.expandAll.defaults = {
        ...
        expTxt : 'Click to expand.', // the text of the switch for expanding
        cllpsTxt : 'Click to collapse.', // the text of the switch for collapsing
        ...
        scroll : true, // false or true. If true, the switch 'Expand All/Collapse All' will be dinamically repositioned to remain in view when the collapsible element closes
        offset : 20,
